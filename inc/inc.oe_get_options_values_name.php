<?php
/* -------------------------------------------------------------------------------------
* 	ID:						$Id: oe_get_options_values_name.inc.php 126 2011-08-05 15:18:24Z peter $
...
function oe_get_options_values_name($products_options_values_id, $language = '') {
	global $db;
	...
	return $product->fields['products_options_values_name'];
}
?>